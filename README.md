...
REVIEW_QUEUE_CONCURRENCY=1
REVIEW_QUEUE_MAX_SIZE=100
REVIEW_QUEUE_MAX_ATTEMPTS=2
REVIEW_QUEUE_RETRY_DELAY_MS=15000
TRIAGE_QUEUE_CONCURRENCY=1
TRIAGE_QUEUE_MAX_SIZE=100
TRIAGE_QUEUE_MAX_ATTEMPTS=1
TRIAGE_QUEUE_RETRY_DELAY_MS=30000
...
`docker-compose.prod.yml` mounts this path into both `bff` and `agent` containers.
