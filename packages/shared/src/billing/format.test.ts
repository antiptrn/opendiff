...
import { formatCents, formatCurrency, formatDate, formatRoleName, getTierName } from "./format";
...
describe("getTierName", () => {
  it("returns Self-sufficient for SELF_SUFFICIENT tier", () => {
    expect(getTierName("SELF_SUFFICIENT")).toBe("Self-sufficient");
  });
  ...
  it("returns Ultra for ULTRA tier", () => {
    expect(getTierName("ULTRA")).toBe("Ultra");
  });
