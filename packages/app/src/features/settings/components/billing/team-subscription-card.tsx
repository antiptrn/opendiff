        ...
        {subscription?.status === "ACTIVE" && (
          <>
            ...
            <div className="flex gap-2 mt-6">
              {subscription.cancelAtPeriodEnd ? (
                <LoadingButton isLoading={isReactivating} loadingText="Reactivating..." onClick={onReactivateSubscription}>Reactivate</LoadingButton>
              ) : (
                <>
                  <Button
                  ...
                  <AlertDialog open={showCancelDialog} onOpenChange={(open) => !isCancelPending && setShowCancelDialog(open)}>
                    <AlertDialogContent>
                      <AlertDialogHeader>
                      ...
                      <AlertDialogFooter>
                        <LoadingButton variant="outline" isLoading={isCancelPending} loadingText="Cancelling..." onClick={handleCancel}>
                          Cancel Subscription
                        </LoadingButton>
                        <AlertDialogCancel variant="default" disabled={isCancelPending}>Keep Subscription</AlertDialogCancel>
                      </AlertDialogFooter>
                    </AlertDialogContent>
                  </AlertDialog>
                </>
