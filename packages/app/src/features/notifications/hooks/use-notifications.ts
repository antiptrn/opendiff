...
/** Fetches a paginated, auto-refreshing infinite list of notifications for the organization. */
...
/** Marks a single notification as read with optimistic cache update. */
...
/** Marks all notifications as read with optimistic cache update. */
