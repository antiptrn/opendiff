...
export function TeamCard({ isYearly, onGetStarted, isLoading }: TeamCardProps) {
  ...
  const monthlyTokenQuota = 8_000_000;
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        <div className="flex-1">
          ...
          <p className="text-muted-foreground mt-1">
            For teams that need multiple seats. All the features of Ultra, with volume pricing.
          </p>
        ...
        <div className="flex flex-col items-center gap-4 md:items-end">
          ...
          <div className="text-center md:text-right">
            ...
            <p className="text-sm text-muted-foreground">
              {formatTokenQuota(monthlyTokenQuota * seatCount)} tokens/month pooled
            </p>
