...
const testimonials = [
  {
    quote:
      "OpenDiff transformed how our team works. We shipped our entire Q4 roadmap in just 6 weeks after implementing their AI workflow recommendations.",
    author: "Sarah Chen",
    role: "VP Engineering",
    company: "TechCorp",
  },
  ...
  {
    quote:
      "We were worried about security and compliance, but OpenDiff helped us implement AI tools that meet all our enterprise requirements.",
  ...
  {
    quote:
      "OpenDiff doesn't just implement tools - they transform your entire engineering culture around AI-augmented development.",
  ...
  {
    quote:
      "Our junior developers are now performing at mid-level thanks to the AI-assisted workflows OpenDiff set up for us.",
    author: "James Wilson",
