...
flowchart TB
    ...
    subgraph Frontend["Frontend Applications"]
        Website["opendiff-website<br/><i>Marketing & Landing</i><br/>:5173"]
        App["opendiff-app<br/><i>Console Dashboard</i><br/>:5174"]
    end

    subgraph Backend["Backend Services"]
        BFF["opendiff-bff<br/><i>API Gateway</i><br/>:3001"]
        Agent["opendiff-review-agent<br/><i>AI Code Reviewer</i><br/>:3000"]
    end

    subgraph SharedLibs["Shared Libraries"]
        Components["opendiff-components<br/><i>UI Components</i>"]
        Shared["opendiff-shared<br/><i>Business Logic</i>"]
        Assets["opendiff-assets<br/><i>Static Assets</i>"]
    end
    ...
    class Components,Shared,Assets shared
...
flowchart BT
    subgraph Apps["Applications"]
        App["opendiff-app"]
        Website["opendiff-website"]
    end

    subgraph Services["Services"]
        BFF["opendiff-bff"]
        Agent["opendiff-review-agent"]
    end

    subgraph Libraries["Shared Libraries"]
        Shared["opendiff-shared"]
        Components["opendiff-components"]
        Assets["opendiff-assets"]
    end
    ...
    class Shared,Components,Assets lib
```
...
| Service | Port |
|---------|------|
| opendiff-website | 5173 |
| opendiff-app | 5174 |
| opendiff-bff | 3001 |
| opendiff-review-agent | 3000 |
