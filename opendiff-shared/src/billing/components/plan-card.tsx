...
import {
  ...
  TooltipRoot,
  TooltipTrigger,
} from "opendiff-components/components/ui/tooltip";
import type { SubscriptionTier } from "../../auth";
import { type Plan, TIER_HIERARCHY } from "../pricing.constants";
import { cn } from "opendiff-components";
...
export function PlanCard({
  ...
  return (
    <div className={cn("rounded-4xl bg-card p-6 flex flex-col", className)}>
      ...
      <div className="mt-4">
        <NumberFlow
          ...
          suffix="/month"
          className="text-2xl font-medium [&>span:last-child]:text-base [&>span:last-child]:font-normal [&>span:last-child]:text-muted-foreground"
        />
