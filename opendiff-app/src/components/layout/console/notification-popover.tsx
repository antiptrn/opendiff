...
import { Button, Popover, PopoverContent, PopoverTrigger } from "opendiff-components/components";
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2.5">
          <span className="text-base font-medium truncate">{notification.title}</span>
