...
TUNNEL_NAME="${PREVIEW_TUNNEL_NAME:-opendiff-previews}"
PREVIEW_AUTH_PROXY_HOSTNAME="${PREVIEW_AUTH_PROXY_HOSTNAME:-api-preview.opendiff.dev}"
PREVIEW_AUTH_PROXY_PORT="${PREVIEW_AUTH_PROXY_PORT:-9999}"
...
cat >> "$CONFIG_FILE" <<EOF
  - hostname: ${PREVIEW_AUTH_PROXY_HOSTNAME}
    service: http://localhost:${PREVIEW_AUTH_PROXY_PORT}
EOF
