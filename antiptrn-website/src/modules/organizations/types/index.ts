...
export type { OrganizationRole, SubscriptionTier, UserOrganization } from "@features/auth";

// Org-level subscription info
export interface OrgSubscription {
  tier: import("@features/auth").SubscriptionTier;
...
export interface OrganizationMember {
  ...
  role: import("@features/auth").OrganizationRole;
  joinedAt: string;
