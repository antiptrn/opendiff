...
```bash
git clone https://github.com/JuliusWallblom/antiptrn-review-agent.git
cd antiptrn-review-agent
npm install
```
...
# Or build manually
docker build -t antiptrn-review-agent .
docker run -d -p 3000:3000 --env-file .env antiptrn-review-agent
```
